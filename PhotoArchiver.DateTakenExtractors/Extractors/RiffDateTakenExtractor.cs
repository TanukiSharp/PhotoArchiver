...
namespace DateTakenExtractors.Extractors
{
    public class RiffDateTakenExtractor : IDateTakenExtractor
    {
        ...
        public static bool ReadIDITDateTaken(byte[] data, out DateTime dateTaken)
        {
            dateTaken = DateTime.MinValue;
        ...
        public static bool ReadAVIFDateTaken(byte[] exifTags, out DateTime dateTaken)
        {
            dateTaken = DateTime.MinValue;
